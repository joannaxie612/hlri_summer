...
```{r}
if(file.exists("/data/jx303/hlri_summer/data/anchors_KO_cocult.RData")){
  
  load(file = "/data/jx303/hlri_summer/data/anchors_KO_cocult.RData")
    ...
    save(anchors, file = "/data/jx303/hlri_summer/data/anchors_KO_cocult.RData")
