...
render_gsea_report(
  ...
  base_output_dir = "/data/jx303/hlri_summer/data/DKO_GSEA"
)
```
...
```{r}
de_results_celltypes <- readRDS(file.path("/data/jx303/hlri_summer/data/DKO_GSEA","COPDvsNA", "de_results_celltypes.rds"))
...
de_results_celltypes <- readRDS(file.path("/data/jx303/hlri_summer/data/DKO_GSEA","CAFvsNA", "de_results_celltypes.rds"))
...
de_results_celltypes <- readRDS(file.path("/data/jx303/hlri_summer/data/DKO_GSEA","CAFvsCOPD", "de_results_celltypes.rds"))
