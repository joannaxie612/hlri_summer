...
render_gsea_report(
  ...
  base_output_dir = "/data/jx303/hlri_summer/data/QKO_GSEA"
)
```
...
```{r}
de_results_celltypes <- readRDS(file.path("/data/jx303/hlri_summer/data/QKO_GSEA","COPDvsNA", "de_results_celltypes.rds"))
...
de_results_celltypes <- readRDS(file.path("/data/jx303/hlri_summer/data/QKO_GSEA","CAFvsNA", "de_results_celltypes.rds"))
...
de_results_celltypes <- readRDS(file.path("/data/jx303/hlri_summer/data/QKO_GSEA","CAFvsCOPD", "de_results_celltypes.rds"))
